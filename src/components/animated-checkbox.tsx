...
import Animated,
{ Easing, useSharedValue, useAnimatedProps, withTiming, interpolateColor } from 'react-native-reanimated'
...
const AnimatedCheckbox = (props: Props) => {
  const { checked } = props
  const checkmarkColor = useColorModeValue('#fff', '#fff')
  const highlightColor = useColorModeValue('#57ace5', '#00ff00')
  const boxOutLineColor = useColorModeValue('#57ace5', '#fff')
