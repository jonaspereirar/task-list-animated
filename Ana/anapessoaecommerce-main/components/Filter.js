    ...
    return (
        <div className="input-group">
            ...
            <form autoComplete="off" className="mt-2 col-md-8 px-0">
                ...
                value={search.toLowerCase()} onChange={e => setSearch(e.target.value)} placeholder="procurar:" />
            </form>
            ...
            <div className="input-group-prepend col-md-2 px-0 mt-2">
                ...
                value={sort} onChange={handleSort}>
                     ...
                     <option value="-price">Preço: Alto-Baixo</option>
                     <option value="price">Preço: Baixo-Alto</option>
