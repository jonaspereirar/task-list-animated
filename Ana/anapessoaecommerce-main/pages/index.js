...
import CookieStart from '../components/Cookie'
...
const Home = (props) => {
  ...
  const handleDeleteAll = () => {
    ...
    products.forEach(product => {
      ...
      fbq.event('Purchase', { id: product.id, type:'DELETE_PRODUCT'})
    })
  ...
  return(
    <div className="home_page">
      <Header />
      <Head>
        <title>anapessoa.art - Ecommerce de produtos de artesanato.</title>
